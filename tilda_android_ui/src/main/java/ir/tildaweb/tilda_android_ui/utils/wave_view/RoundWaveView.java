package ir.tildaweb.tilda_android_ui.utils.wave_view;
...
public class RoundWaveView extends View {
    ...
    public RoundWaveView(Context context, @Nullable AttributeSet attrs) {
        ...
        startColor = typedArray.getColor(R.styleable.RoundWaveView_startColor, Color.RED);
        endColor = typedArray.getColor(R.styleable.RoundWaveView_endColor, Color.BLUE);
        typedArray.recycle();
        init(pointCount);
...
//        paint.setColor(Color.MAGENTA);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        paint.setShader(new LinearGradient(0, 0, 0, h, startColor, endColor, Shader.TileMode.MIRROR));
